...
const AllScholarship2 = () => {
  ...
  return (
    <div className="mx-auto mt-5 ml-5 mb-5">
        <h2 className="text-2xl font-bold mb-4 text-center">All Scholarship</h2>
...
export default AllScholarship2;
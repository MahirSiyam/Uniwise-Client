        ...
        <div className="modal modal-open">
          <div className="modal-box relative">
            ...
            <p>
              ...
              {detailsApp.appliedDate
                ? new Date(detailsApp.appliedDate).toLocaleDateString()
                : "N/A"}
            </p>
            <p>
              <strong>Scholarship Deadline:</strong>{" "}
              {detailsApp.scholarshipDeadline
                ? new Date(detailsApp.scholarshipDeadline).toLocaleDateString()
                : "N/A"}
            </p>
          </div>
        </div>
